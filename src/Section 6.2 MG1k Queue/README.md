This folder contains three R function codes and one R script (RunMG1kExpr.R) used to run the M/G/1/k queue example presented in the paper. The functions are described below:
